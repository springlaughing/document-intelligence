...
public sealed class AnalysisFailedEventListener : BackgroundService, IAsyncDisposable
{
    private readonly ServiceBusMessageDispatcher<AnalysisFailedEvent> _dispatcher;
    private int _dispatcherDisposed;

    public AnalysisFailedEventListener(
        IConfiguration config,
        ServiceBusClient client,
        ILogger<ServiceBusMessageDispatcher<AnalysisFailedEvent>> logger,
        ...
        JsonSerializerOptions jsonOpt)
    {
        ...
        _dispatcher = new ServiceBusMessageDispatcher<AnalysisFailedEvent>(
            client,
            scopeFactory,
            logger,
            entityName: topic,
